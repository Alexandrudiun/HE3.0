...
if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        for($i=0;$i<2;$i++){
        $location[$i]="https://idcrew.shop/img/upload/" . $photo_names[$i]; // Moved inside the while loop
        }
        ...
        echo '<div class="card">';
        for($i=0;$i<2;$i++){
        echo '<img src="' . $location[$i] . '" alt="' . $row['name'] . '" style="max-width: 100px; max-height: 100px;">';}
