...
if(isset($_POST['submit'])){
    ...
    if($uploadCount > 0){
        ...
        $query = "UPDATE INTO post (images) VALUES ('$photoNames') WHERE email = '$email' AND name = '$name' AND title = '$title' AND price = '$price' AND description = '$description' AND skills = '$skills'";
