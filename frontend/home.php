    ...
    <div class="flex-2-column">
      ...
      if (mysqli_num_rows($result) > 0) {
          while ($row = mysqli_fetch_assoc($result)) {
              ...
              echo '<h3 class="service-title">' . $row['name'] . '</h2>';
              echo '<h2 class="service-price">Price: ' . $row['price'] . '</p>';
      ...
      <div class="cards">
        <div class="card">
          <img src="/img/logo384.jpg" alt="insert img">
          <div class="info-area">
          <h3 class="service-title">Anunţ nou</h3>
